<?php
  ...
  $SQL = "SELECT idSecaoPosts, titulo, conteudo, img, usuario, nomeSite, dataAlteracao, dataAprovacao, dataPostagem FROM post JOIN perfil ON autorAlteracao = idPerfil WHERE idPost = $id;";
  ...
  if ($result->num_rows > 0) { // Exibindo cada linha retornada com a consulta
    while ($exibir = $result->fetch_assoc()){
      ...
      $sql = "SELECT usuario FROM post JOIN perfil ON autorAprovacao = idPerfil WHERE idPost = $id;";
