...
<!-- Page Content -->
    <div class="container">
      ...
      <?php
        ...
        if (isset($_SESSION['login'])){
          ...
          if (isAdmin($_SESSION['tipo'])){
            ...
            $sqlPostsPendentes = "SELECT aprovacao, cadastro FROM postpendente WHERE aprovacao = 0 AND cadastro = 0 AND idSecaoPosts = " . $idSecao;
      ...
      <?php
        ...
        $SQL = "SELECT idPost, titulo, conteudo, img, nomeSite, dataPostagem FROM post JOIN perfil ON autorAlteracao = idPerfil WHERE cadastro = 1 AND idSecaoPosts = " . $idSecao . " ORDER BY dataPostagem DESC LIMIT $inicio, $quantidade;";
      ...
      $sqlTotalRegistros = "SELECT COUNT(idPost) AS totalRegistros FROM post WHERE idSecaoPosts = " . $idSecao . ";";
