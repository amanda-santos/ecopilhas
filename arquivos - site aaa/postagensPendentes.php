...
?>
          ...
          <div class="container">
            ...
            <?php
              ...
              $SQL = "SELECT idPostPendente, titulo, conteudo, img, nomeSite, dataAlteracao FROM postpendente JOIN perfil ON autorAlteracao = idPerfil WHERE aprovacao = 0 AND cadastro = 0 AND idSecaoPosts = " . $idSecao . " ORDER BY dataAlteracao DESC LIMIT $inicio, $quantidade;";
            ...
            $sqlTotalRegistros = "SELECT COUNT(idPostPendente) AS totalRegistros FROM postpendente WHERE aprovacao = 0 AND cadastro = 0 AND idSecaoPosts = " . $idSecao . ";";
