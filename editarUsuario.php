...
<form enctype="multipart/form-data" role="form" data-toggle="validator" action="atualizarUsuario.php" method="post">
    ...
    <button type="submit" name="atualizar" class="float-center btn btn-primary">Atualizar</button>
</form>
