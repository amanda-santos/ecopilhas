    ...
    if (isAdmin($_SESSION['tipo']) == false) {
      ...
      if (!isset($_GET['id'])) { //se não tiver nenhum id passado pela url deve-se redirecionar o usuário para a página inicial
        ...
        if (isset($_POST["atualizar"])) {
          ...
          $sqlAtualizarPagina = "UPDATE PaginaPendente SET nome = '".$nomeAtualizado."', conteudo = '".$conteudoAtualizado."', dataAlteracao = CURRENT_TIME(), Usuario_idUsuario = '".$autor."', aprovacao = 0 WHERE idPaginaPendente = ".$_GET["id"];
