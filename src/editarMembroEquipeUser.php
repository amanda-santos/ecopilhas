<?php
  ...
  if (isset($_SESSION["login"])) { //SE EXISTIR AUTENTICAÇÃO
    if (isAdmin($_SESSION['tipo']) == false) {
      ...
      if (!isset($_GET['id'])) { //se não tiver nenhum id passado pela url deve-se redirecionar o usuário para a página inicial
        ...
        if (isset($_POST["atualizar"])) {
            ...
            $sql = 'UPDATE MembroEquipePendente 
                      SET nome = "' . $nome . '", email = "' . $email . '", descricao = "' . $descricao . '", cargo = "' . $cargo . '", img = "' . $img . '", Usuario_idUsuario = ' . $autor . ', dataAlteracao = CURRENT_TIME(), aprovacao = 0 
          ...
          <div class="row">
            <div class="col-md-12"> 
              ...
              <div class = "post">
                ...
                <hr>
                <form class="form-horizontal" method="POST" action="editarMembroEquipeUser.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
